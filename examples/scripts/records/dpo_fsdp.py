...
if __name__ == "__main__":
    ...
    model_ref.to(distributed_state.device)
    # tokenizer.to(distributed_state.device)
    ...
    # Code added for FSDP not in the same device error from https://github.com/huggingface/trl/issues/1147#issuecomment-1896206757
